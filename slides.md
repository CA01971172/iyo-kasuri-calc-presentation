...
<div class="abs-bot m-12 w-full flex justify-between pr-24 border-t border-gray-500/30 pt-4">
  <div class="text-left">
    ...
    <div class="text-xl text-gray-300">河原電子ビジネス専門学校</div>
  </div>

  <div class="text-right">
    <div class="text-sm opacity-60 italic mb-1">Presented by</div>
    <div class="text-xs opacity-80 font-medium tracking-widest mb-1">ITイノベーション科 4年</div>
    <div class="text-2xl font-bold tracking-tight">村上 聖音</div>
  </div>
</div>
